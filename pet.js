...
//     .then((answers) => {
//     console.log("Congratulations on your new pet" + answers.type)
//   },
...
//     Pet = new Tortoise (answers.name,Date.getFullYear())
//     choices = "Toroise"
//   } else if (answers.name === "Hen"){
//       Pet = new Hen (answers.name,Date.getFullYear())
//       choices ="Hen"
//   } else {
//       Pet = new Scorpion (answers.name, Date.getFullYear())
//       choices = "Scorpion"
//   }
